...
if (isset($_POST['tombol'])){
    if ($_POST ['tombol'] == "edit"){ // tombol simpan untuk editing
        ...
        // jika nama file di isi
        if (!empty($nama_file)) move_uploaded_file($_FILES["laporan"]["tmp_name"], $target_file);

        //update tabel pustaka1
        if (!empty($nama_file)) {
            mysqli_query($koneksi, "UPDATE pustaka1 SET judul=\"$judul\",tahun='$tahun',tipe='$tipe',pembimbing1='$pembimbing1',pembimbing2='$pembimbing2',ketua_penguji='$ketua_penguji',penguji1='$penguji1',penguji2='$penguji2',penguji3='$penguji3',sekretaris='$sekretaris',nama_file=\"$nama_file\" WHERE id='$id_judul'");
            echo "<script>window.location.replace('pustaka.php')</script>";
        } else {
            mysqli_query($koneksi, "UPDATE pustaka1 SET judul=\"$judul\",tahun='$tahun',tipe='$tipe',pembimbing1='$pembimbing1',pembimbing2='$pembimbing2',ketua_penguji='$ketua_penguji',penguji1='$penguji1',penguji2='$penguji2',penguji3='$penguji3',sekretaris='$sekretaris' WHERE id='$id_judul'");
            echo "<script>window.location.replace('pustaka.php')</script>";
        }
        ...
        }   else echo "<div class=\"alert alert-primary alert-dismissible fade show\">
                <button type=button class=btn-close data-bs-dismiss=alert></button>
                <strong>None!</strong> Data tidak ada perubahan..
                /div>";
        ...
        if ($_GET['t'] == "edit") {
            ...
            //sql tampilkan data
            $q = mysqli_query($koneksi, "SELECT judul,tahun,tipe,pembimbing1,pembimbing2,ketua_penguji,penguji1,penguji2,penguji3,sekretaris,nama_file FROM pustaka1 WHERE id='$id'");
                        ...
                        <div class="container">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    ?>
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $judul ?>"
                                                placeholder="Masukkan Judul TA/Magang" name="judul" required>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 mb-3" id="ketua">
                                        ...
                                        <div class="mb-3">
                                            <label for="formFile" class="form-label">Upload File Laporan Magang/Tugas Akhir</label>
                                        ...
                                        if (isset($_GET['t'])) {
                                            ...
                                            while ($d = mysqli_fetch_row($q)) {
                                                ...
                                                if ($nm == 1) {
                                                    ...
                                                    $id_mhs = "mhs_del";
                                                    $button_class = "button_min";
                                                    $button_ket = "-";
                                                }
                                        
                                        ?>

                                        <div class="row mb-3" id="<?php echo $id_mhs?>">
                                            <div class="col-sm-6 hstack">
                                                <input type="text" class="form-control" value="<?php echo "$nim $nama_mhs";?>" placeholder="Ketik nama mahasiswa" name="mhs[]">
                                                <button class="btn btn-outline-success ms-2 <?php echo $button_class ?>" type="button"><?php echo $button_ket ?></button>
                                            </div>
                                        </div>
                                        <?php
                                        }
                                    ...
                                    ?>
                                        <button type="submit" name="tombol" id="pencet" class="btn btn-primary mt-5"
    ...
    <script type="text/javascript">
            $(document).ready(function() {
                $("#pencet").click(function() {
                    ...
                    window.location.replace('pustaka.php')
                });
            });
    </script>
